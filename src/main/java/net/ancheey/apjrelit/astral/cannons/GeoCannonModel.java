...
public class GeoCannonModel<T extends GeoAnimatable> extends GeoModel<T> {
	...
	public GeoCannonModel(String cannonModel, String cannonTexture, String cannonAnimation) {
		this.cannonModel =  ResourceLocation.fromNamespaceAndPath(APJRelitCore.MODID,"models/cannons/"+cannonModel+".geo.json");
	...
	public GeoCannonModel(String model){
		this.cannonModel =  ResourceLocation.fromNamespaceAndPath(APJRelitCore.MODID,"models/cannons/"+model+".geo.json");
